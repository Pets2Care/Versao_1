...
var SearchPage = /** @class */ (function () {
    ...
    SearchPage.prototype.applySegmentFilter = function (type) {
        console.log('applySegmentFilter -> type = ', type);
        if (type === 'all') {
            this.filteredPetsData = this.petsData;
        }
        else {
            this.filteredPetsData = this.petsData.filter(function (i) { return i.type === type; });
            console.log('filtrados = ', this.filteredPetsData);
        }
        this.result = this.filteredPetsData;
    };
    SearchPage.prototype.filterArray = function (ev) {
...
var routes = [
    ...
    },
    {
        ...
        loadChildren: function () {
            return __webpack_require__.e(/*! import() | detail-donation-detail-donation-module */ "detail-donation-detail-donation-module").then(__webpack_require__.bind(null, /*! ./detail-donation/detail-donation.module */ "Q5NW")).then(function (m) { return m.DetailDonationPageModule; });
        },
    },
];
